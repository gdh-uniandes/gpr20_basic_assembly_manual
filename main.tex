...
\begin{onehalfspacing}
    \begin{xltabular}{\linewidth}{|c|X|}
        ...
        5 & Download the \texttt{gpr20\_msgs}, \texttt{gpr20\_main\_control}, \texttt{gpr20\_vna\_acquisition} and \texttt{gpr20\_data\_processing} repositories inside the \texttt{src} folder of the \texttt{gpr20\_ws} directory. \\ \hline
